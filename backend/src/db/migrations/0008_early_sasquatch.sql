...
CREATE INDEX "pool_reserves_token_idx" ON "pool_reserves" USING btree ("chain_id","token_address");--> statement-breakpoint
CREATE INDEX "pool_reserves_updated_idx" ON "pool_reserves" USING btree ("chain_id","block_number");

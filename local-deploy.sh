...
# 提取合约地址并更新 .env.local
echo -e "${BLUE}📝 提取合约地址并更新 .env.local...${NC}"
...
echo "- 查看账户余额: cast balance <address> --rpc-url http://127.0.0.1:8545"
echo "- 发送ETH: cast send <to> --value <amount> --private-key <key> --rpc-url http://127.0.0.1:8545"
echo "- 调用合约: cast call <contract> <signature> --rpc-url http://127.0.0.1:8545"
echo ""
